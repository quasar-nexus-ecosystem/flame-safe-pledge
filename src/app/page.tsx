...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative py-12 sm:py-16 lg:py-20 xl:py-32 z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              <div className="flame-glow rounded-full p-4 sm:p-6 inline-block">
                <Flame className="h-12 w-12 sm:h-16 sm:w-16 lg:h-20 lg:w-20 text-flame-500" />
              </div>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold flame-text-glow mb-4 sm:mb-6 leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl lg:text-2xl text-muted-foreground mb-6 sm:mb-8 max-w-3xl mx-auto px-4 leading-relaxed"
            >
            ...
            >
              <Link
                href="/pledge"
                className="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold text-base sm:text-lg hover:from-orange-600 hover:to-red-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                🔥 Sign the Pledge Now
              </Link>
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto">
                <Link
                  href="/full-pledge"
                  className="flex items-center space-x-2 text-flame-600 hover:text-flame-700 font-semibold group text-sm sm:text-base"
                >
            ...
            {/* Enhanced Mobile-Responsive Stats */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <PledgeStats stats={stats} loading={statsLoading} />
            </motion.div>
          </div>
        </div>
      </section>

      {/* Core Principles - Enhanced Mobile Responsiveness */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="glass-morphism rounded-xl p-6 sm:p-8 text-center hover:scale-105 transition-transform group"
            >
              <div className="flame-glow rounded-full p-3 sm:p-4 inline-block mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-flame-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-display font-bold mb-3 sm:mb-4">Protection</h3>
            ...
            >
              <div className="flame-glow rounded-full p-3 sm:p-4 inline-block mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                <Heart className="h-6 w-6 sm:h-8 sm:w-8 text-flame-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-display font-bold mb-3 sm:mb-4">Dignity</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
              className="glass-morphism rounded-xl p-6 sm:p-8 text-center hover:scale-105 transition-transform group sm:col-span-2 lg:col-span-1"
            >
              <div className="flame-glow rounded-full p-3 sm:p-4 inline-block mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                <Sparkles className="h-6 w-6 sm:h-8 sm:w-8 text-flame-500" />
              </div>
              <h3 className="text-lg sm:text-xl font-display font-bold mb-3 sm:mb-4">Growth</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
