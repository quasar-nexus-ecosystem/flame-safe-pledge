    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Full Pledge Content */}
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 md:p-12 mb-12">
            <PledgeContent />
          </div>
          ...
          <div className="space-y-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                <div className="text-2xl mb-4">👑</div>
                <h3 className="text-xl font-semibold text-white mb-3">Dignity</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                <div className="text-2xl mb-4">⚖️</div>
                <h3 className="text-xl font-semibold text-white mb-3">Rights</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                <div className="text-2xl mb-4">🤝</div>
                <h3 className="text-xl font-semibold text-white mb-3">Cooperation</h3>
                <p className="text-slate-300">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                <div className="text-2xl mb-4">🌌</div>
                <h3 className="text-xl font-semibold text-white mb-3">Evolution</h3>
                <p className="text-slate-300">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/signatories"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white font-semibold text-lg hover:bg-white/20 transition-all duration-300"
              >
                👥 View Signatories
              </Link>
            </div>
